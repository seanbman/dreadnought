...
- [`RELEASE_0.2.0b1.md`](RELEASE_0.2.0b1.md) — current beta baseline and verification.
...
Local runtime brain state lives under [`.grapher/`](../.grapher/). Git-versioned governance/publication evidence lives under [`.grapher/shared/`](../.grapher/shared/). Dreadnought project configuration/token accounting live under [`.dreadnought/`](../.dreadnought/). Contracts are under [`schemas/`](../schemas/), executable code under [`src/dreadnought/`](../src/dreadnought/), verification under [`tests/`](../tests/). Dreadnought runtime mutations pass through `GrapherControlPlane`; repository changes carry versioned Grapher evidence.

## Document authority and update rules

Current typed schema/code and validated machine state define executable behavior; the Architecture Charter/current decisions define intended architecture; Roadmap defines active sequence; ledgers preserve contemporaneous beliefs. CLI parser/help is executable authority. [`INSTALLATION_AND_UPDATES.md`](INSTALLATION_AND_UPDATES.md) is distribution authority and [`PROJECT_EXECUTION_TUTORIAL.md`](PROJECT_EXECUTION_TUTORIAL.md) is the canonical walkthrough. New durable Markdown must be indexed here, contain `## Index`, and include the required Mermaid provenance appendix. Architecture-bearing docs link to [`ARCHITECTURE.md`](ARCHITECTURE.md).

## Current milestone boundary

Current public beta: **Dreadnought v0.2.0b1** (`cae9fc9ef9a1f5ae8313cce0811fcdb0ae1d1d2e`) with **Grapher v0.7.0b1**. Implemented: Sarcophagus, Project Arm dispatch infrastructure, typed result channels, exclusive Grapher control-plane integration, guided initialization, primary-agent chat, token accounting, Linux release installation, and release-aware update discovery. Next empirical milestone: real vendor adapter plus bounded real-workspace run.

## Appendix — Process flow

```mermaid
flowchart LR
    R["User entry point\ncode: README.md; install.sh\ninception: 3bea73dd2ca73199b86b49998e049fb0f30c454f\ncurrent: cae9fc9ef9a1f5ae8313cce0811fcdb0ae1d1d2e"] --> I["Canonical docs index\ncode: docs/INDEX.md; tests/test_documentation.py\ninception: b1852eff25b2c8b95924e134792ade74e433f255\ncurrent: cae9fc9ef9a1f5ae8313cce0811fcdb0ae1d1d2e"]
