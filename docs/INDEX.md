...
- [`GRAPHER_INTEGRATION.md`](GRAPHER_INTEGRATION.md) — exclusive Dreadnought write authority, embedded Grapher brain boundary, configuration flow, and shared-state publication model.
...
Sarcophagus, Project Arm dispatch, and the typed agent result channel are merged. The Grapher integration now has an explicit embedded brain boundary: subordinate agents submit testimony through Dreadnought, and Dreadnought alone mutates Grapher. Milestone 8 still requires a real vendor adapter and bounded real-workspace run before empirical validation. [Process map](#appendix--process-flow)

## Appendix — Process flow

```mermaid
flowchart LR
    R["Repository entry points\ncode: README.md; AGENTS.md\ninception: 3bea73dd2ca73199b86b49998e049fb0f30c454f\ncurrent: f395fb7a0a149d901d7db8d73dd63b52f5682185"] --> I["Canonical docs index\ncode: docs/INDEX.md; tests/test_documentation.py\ninception: b1852eff25b2c8b95924e134792ade74e433f255\ncurrent: 97f4b0061b7a97fa8b51d91c4d8ddb39b892b255"]
    I --> C["CLI usage guide\ncode: src/dreadnought/cli.py\ninception: 2ddda47a622cc66b90e4a5ec65ea09262e002644\ncurrent: f395fb7a0a149d901d7db8d73dd63b52f5682185"]
